...
const PRESETS: Record<TimeOfDayName, TimeOfDayPreset> = {
  ...
  night: {
    name: 'night',
    ambient: { color: 0x1a2233, intensity: 0.8 },
    hemi: { sky: 0x202a40, ground: 0x101018, intensity: 0.6 },
    dir: { color: 0x405070, intensity: 0.8 },
    ceiling: 1.2,
    desk: 2.0,
    term: 1.2,
    tv: 1.4,
    bed: 0.2,
    cityLight: { color: 0x3344aa, intensity: 1.4 },
    corner: 0.3,
    windowGlow: { color: 0x3344aa, intensity: 0.6, spotIntensity: 1.6 },
    cityEmissiveMultiplier: 1.8,
    pcLedMultiplier: 1.5,
  },
};
