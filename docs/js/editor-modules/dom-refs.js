...
const OPTIONAL_IDS = ['selX', 'selZ', 'selY', 'selYRange', 'selRot', 'selName', 'btnCopyLink', 'btnSaveSlot1', 'btnLoadSlot1', 'btnSaveSlot2', 'btnLoadSlot2', 'btnSaveSlot3', 'btnLoadSlot3', 'snapToggle', 'snapSize'];
