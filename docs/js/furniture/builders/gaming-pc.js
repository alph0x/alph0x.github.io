...
function buildGamingPC(cfg) {
  ...
  const caseMat = makeStd({ color: 0x1c1c1f });
  const glassMat = new THREE.MeshStandardMaterial({ color: 0x111114, transparent: true, opacity: 0.4, flatShading: true, roughness: 1, metalness: 0 });
