...
function buildBed(cfg) {
  ...
  const base = makeStd({ color: 0x2a2a30, roughness: 0.7, metalness: 0.1 });
  const mattress = makeStd({ color: 0x3a3a40, roughness: 0.9, metalness: 0.0 });
  const pillow = makeStd({ color: 0x4a4a55, roughness: 0.95, metalness: 0.0 });
  const blanket = makeStd({ color: 0x222228, roughness: 0.85, metalness: 0.0 });
