...
const META = {
  ...
  sofa:           { category: 'furniture', dimensions: '1.8 × 0.8 × 0.6 m',   icon: '🛋️' },
  coffeeTable:    { category: 'furniture', dimensions: '1.0 × 0.6 × 0.4 m',   icon: '☕' },
  fridge:         { category: 'furniture', dimensions: '0.7 × 0.7 × 1.8 m',   icon: '🧊' },
  kitchen:        { category: 'furniture', dimensions: '2.0 × 1.5 × 1.0 m',   icon: '🍳' },
  bathroom:       { category: 'furniture', dimensions: '1.5 × 1.5 × 1.0 m',   icon: '🚿' },
  mirror:         { category: 'furniture', dimensions: '0.8 × 0.05 × 1.2 m',  icon: '🪞' },
